# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/강순자.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/강순자.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "강순자", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "사원", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "sjkang@kyungdo_furniture.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "010-077-3066", text_size: 12)
  relayout!
end
