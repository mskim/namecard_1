# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/김민수.pdf"
...
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "김민수", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "대표", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "mskimsid@gmail.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "010-7468-8222", text_size: 12)
  relayout!
end
...
personal2 = RLayout::Container.new(tag: "personal2", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "en_name", text_string: "Min Soo Kim", text_size: 12)
