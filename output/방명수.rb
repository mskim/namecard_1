# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/방명수.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/방명수.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "방명수", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "대리", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "msbang@myungsung_market.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "011-174-2033", text_size: 12)
  relayout!
end
...
personal2 = RLayout::Container.new(tag: "personal2", width: 150, height: 60) do
  ...
  RLayout::Text.new(parent: self, tag: "en_title", text_string: "Deputy-Manager", text_size: 12)
  RLayout::Text.new(parent: self, tag: "email", text_string: "msbang@myungsung_market.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "011-174-2033", text_size: 12)
  relayout!
end
