# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/김경덕.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/김경덕.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "김경덕", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "이사", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "ggrim@naver.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "010-3206-5292", text_size: 12)
  relayout!
end
...
personal2 = RLayout::Container.new(tag: "personal2", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "en_name", text_string: "Duke Kim", text_size: 12)
