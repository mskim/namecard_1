# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/이소정.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/이소정.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "이소정", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "주임", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "sjlee@shinjang_design.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "016-471-2187", text_size: 12)
  relayout!
end
...
personal2 = RLayout::Container.new(tag: "personal2", width: 150, height: 60) do
  ...
  RLayout::Text.new(parent: self, tag: "en_title", text_string: "Supervisor", text_size: 12)
  RLayout::Text.new(parent: self, tag: "email", text_string: "sjlee@shinjang_design.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "016-471-2187", text_size: 12)
  relayout!
end
