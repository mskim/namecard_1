# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/송병준.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/송병준.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "송병준", text_size: 12, font: "smGothicP-W70")
  RLayout::Text.new(parent: self, tag: "title", text_string: "과장", text_size: 12, font: "smMyungjoP-W30")
  RLayout::Text.new(parent: self, tag: "email", text_string: "bjsong@suhkyung_construction.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "016-484-4833", text_size: 12)
  relayout!
end
