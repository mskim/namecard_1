# encoding: UTF-8
@output_path = "/Users/mskim/Development/namecard_1/output/김성근.pdf"
...
# qrcode 	= RLayout::Image.new(tag: "qrcode", local_image: "qrcode/김성근.png", width: 200, height: 200)
# This goes somewhere in the middle
personal = RLayout::Container.new(tag: "personal", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "name", text_string: "김성근", text_size: 12, font: "smGothicP-W70")
...
personal2 = RLayout::Container.new(tag: "personal2", width: 150, height: 60) do
  RLayout::Text.new(parent: self, tag: "en_name", text_string: "Sung Kun Kim", text_size: 12)
  RLayout::Text.new(parent: self, tag: "en_title", text_string: "VP", text_size: 12)
  RLayout::Text.new(parent: self, tag: "email", text_string: "mskimsid@gmail.com", text_size: 12)
  RLayout::Text.new(parent: self, tag: "cell", text_string: "010-7468-8222", text_size: 12)
  relayout!
end
